...
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', true, 'professor.seed@lab03.com', 'Professor Seed', 'PROFESSOR', '$2a$10$lDA9VY686MwitgW3/2/mtOAPVqXVylyB6mvOKmhmJBunCTICZws3C');
...
INSERT INTO usuario (id, ativo, email, nome, papel, senha_hash) VALUES
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', true, 'gabrielvieira200481@gmail.com', 'Aluno Seed', 'ALUNO', '$2a$10$lDA9VY686MwitgW3/2/mtOAPVqXVylyB6mvOKmhmJBunCTICZws3C');

INSERT INTO aluno (id, cpf, rg, endereco, curso, instituicao_id, saldo_atual) VALUES
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '10987654321', 'MG1234567', 'Rua A, 123', 'Engenharia de Software', '11111111-1111-1111-1111-111111111111', 200);

INSERT INTO usuario (id, ativo, email, nome, papel, senha_hash) VALUES
('cccccccc-cccc-cccc-cccc-cccccccccccc', true, 'thalescarvalho622@gmail.com', 'Empresa Seed', 'EMPRESA', '$2a$10$lDA9VY686MwitgW3/2/mtOAPVqXVylyB6mvOKmhmJBunCTICZws3C');
...
-- Garante que o aluno seed sempre tenha 200 moedas (mesmo em re-execucoes)
UPDATE aluno SET saldo_atual = 200 WHERE id = 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb';
UPDATE professor SET saldo_atual = 1000 WHERE id = 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa';
