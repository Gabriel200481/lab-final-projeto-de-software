...
public class ProfessorService {
    ...
    private InstituicaoEnsino buscarInstituicao(String instituicaoId) {
        UUID id;
        try {
            id = UUID.fromString(instituicaoId);
        } catch (IllegalArgumentException e) {
            throw new BusinessException("instituicaoId invalido: " + instituicaoId);
        }
